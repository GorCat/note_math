...
如果已经生产力了 $Q$ 件产品，则再生产 $\Delta Q$ 件产品的成本为

$\Delta C= C(Q+\Delta Q)-C(Q)$

则成本对产量的平均变化率为： $\frac{\Delta C}{\Delta Q}=\frac{C(Q+\Delta Q)-C(Q)}{\Delta Q}$ ，表示已经生产了 $Q$ 件产品，再多生产一件产品的成本，称为<font color=red>边际成本</font>。

边际成本就是多生产一个单位的产品带来的成本。

我们将 $\frac{\Delta C}{\Delta Q}=\frac{C(Q+\Delta Q)-C(Q)}{\Delta Q}$ ，当 $\Delta Q$ 趋于 0 时的极限定义为产量再 $Q$ 时的<font color=red>边际成本</font>(Marginal Cost)，记为 $MC$，即


$$
MC=\lim_{\Delta Q\rightarrow0}\frac{\Delta C}{\Delta Q}=\lim_{\Delta Q\rightarrow0}\frac{C(Q+\Delta Q)-C(Q)}{\Delta Q}
$$

根据导数的定义
$$
MC=\lim_{\Delta Q\rightarrow0}\frac{\Delta C}{\Delta Q}=\frac{dC}{dQ}=C'(Q)
$$
即边际成本为总成本函数 $C$ 对产量 $Q$ 的导数或总成本关于产量的变化率。
