...
$$
\begin{align}
sinx &=x+o(x^{2})=x-\frac{x^{3}}{6}+o(x^{4})\\

cosx &=1-\frac{x^{2}}{2!}+o(x^{3})=1-\frac{x^{2}}{2!}+\frac{x^{4}}{4!}+o(x^{5})\\

e^{x} &=1 + x + o(x) = 1 + x + \frac{x^{2}}{2} +o(x^{2})\\

\ln(1+x) &= x + o(x) = x - \frac{x^{2}}{2} + o(x^{2})
\end{align}
$$
