...
则 $\displaystyle y' = \frac{\psi '(t)}{\varphi'(t)}$ ，$\displaystyle y'' = \frac{\psi''(t)\varphi'(t)-\psi'(t)\varphi''(t)}{\varphi'^{3}(t)}$ ，

可得 $\displaystyle K = \frac{|\varphi'(t)\psi''(t) - \varphi''(t)\psi'(t)|}{[\varphi'^{2}(t) + \psi'^{2}(t)]^{\frac{3}{2}}} $ 。
